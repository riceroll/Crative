...
export const defaultThickness = 1.5;
...
export const boardTypes = {
    ...
    'board_40x40': { width: sizeLarge, height: sizeLarge, thickness: defaultThickness, price: 5.00 ,
        defaultColor: 'grey',
        highlightColor: '#F4809E'        
    },
    'board_40x24': { width: sizeLarge, height: sizeMedium, thickness: defaultThickness, price: 3.50, 
        defaultColor: 'grey',
        highlightColor: '#E3ACCA'        
    },
    'board_40x5': { width: sizeLarge, height: sizeSmall, thickness: defaultThickness, price: 1.50, 
        defaultColor: 'grey',
        highlightColor: '#FFB194'
     },
    'board_24x24': { width: sizeMedium, height: sizeMedium, thickness: defaultThickness, price: 2.50,
        defaultColor: 'grey',
        highlightColor: '#9CD199'
     },
    'board_24x5': { width: sizeMedium, height: sizeSmall, thickness: defaultThickness, price: 1.00,
        defaultColor: 'grey',
        highlightColor: '#6BB7C2'
     },
    'board_5x5': { width: sizeSmall, height: sizeSmall, thickness: defaultThickness, price: 0.75,
        defaultColor: 'grey',
        highlightColor: '#8FA6CA'
     },
